...
class Message {
    ...
    private $locationUpdate=array(); // addLocation / removeLocation / getLocation / getLocationComlement
    private $businessUpdate=array(); // addBusiness / removeBusiness / getBusiness / getBusinessComplement
    ...
    function updateBusiness($businesses) {
        $removeBusiness=array_keys(array_diff($this->getBusiness(),$businesses));
        $addBusiness=array_keys(array_diff($businesses,$this->getBusiness()));
    ...
    function updateLocation($locations) {
        ...
        $removeLocation=array_keys(array_diff($this->getLocation(),$locations));
		
        $addLocation=array_keys(array_diff($locations,$this->getLocation()));
